...
public class PinMongosTest extends DatabaseTestCase {
    ...
    public PinMongosTest(final String filename, final String description, final MongoNamespace namespace,
            ...
            for (BsonValue cur : definition.getArray("operations")) {
                ...
                try {
                    if (operationName.equals("startTransaction")) {
                        ...
                        BsonDocument actualOutcome = createJsonPoweredCrudTestHelper(Fixture.getMongoClient(), namespace).getOperationResults(operation);
